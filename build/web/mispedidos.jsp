<%-- 
    Document   : mispedidos
    Created on : 07-jun-2013, 13:40:31
    Author     : Jorge
--%>
     ...
     <div class="container">
            <div class="row">
                <div class="span3">
                    ...
                    <div class="span9">
                        <h1>Mis Pedidos</h1>
                <s:if test="#request.listado.size()>0">
                    <table class="table table-striped table-condensed">
                        ...
                        <tbody>
                            <s:iterator value="#request.listado" var="pedido">    
                                <tr>
                                    ...
                                    <td>
                                        <a href="<s:url action="VerDetallesPedido"><s:param name="idPed" value="%{idPedido}" ></s:param></s:url>"class="btn btn-primary"><i class="icon-plus-sign"></i> Detalles</a> </li>
                                            </td> 					
                                        </tr>
                            </s:iterator>
                        </tbody>
                ...
                <s:else>
                    <h4>Usted aún no tiene información de pedidos</h4>
                </s:else>
            </div>
</body>
</html>