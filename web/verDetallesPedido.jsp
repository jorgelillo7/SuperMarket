<%-- 
    ...
    Created on : 13-jun-2013, 11:17:11
    Author     : Jorge
--%>
...
<body>
    ...
    <div class="row">
  <div class="span12">
     <h2><strong>Mi Pedido</strong></h2>
    <div class="row">
      <div class="span3">
           <span class="label label-inverse">IDPedido</span>
                        <p>
                            <s:property value="%{#request.pedidoDetallado.idPedido}"/>  
                        </p>
      </div>
      <div class="span3">
          <span class="label label-inverse">Fecha de Inicio</span>
                        <p>
                            <s:date name="%{#request.pedidoDetallado.creacion}" format="dd/MM/yyyy HH:mm" />
                        </p>
      </div>
      <div class="span3">
       <span class="label label-inverse">Precio</span>
                        <p>
                            <s:property value="%{#request.pedidoDetallado.preciototal}"/>€
                        </p>           
      ...
      <div class="span3">
         <span class="label label-inverse">Estado del pedido</span>
                        <p>
                        <p>
                        <s:if test="request.pedidoDetallado.estado == 0">
                            <td><span class="label label-important">Sin Enviar</span></td>
                        </s:if>
                        <s:if test="request.pedidoDetallado.estado == 1">
                            <td><span class="label label-warning">En Camino</span></td>
                        </s:if>
                        <s:if test="request.pedidoDetallado.estado == 2">
                        ...
                        <p>
                            ...
                            <s:property value="%{#request.direccionEnvio.puerta}"/>
                            <s:property value="%{#request.direccionEnvio.localidad}"/> (<s:property value="%{#request.direccionEnvio.codigopostal}"/>)
                ...
                <div class="span9">
                    ...
                    <table class="table table-striped"> 
                        ...
                        <s:iterator value="#request.pedidoDetallado.carrito" var="producto"> 
                            <p>
                            <tbody>
                                <tr>
                                    <td><a href="<s:url action="VerProducto"><s:param name="id" value="%{idProducto}" /> </s:url>"><s:property value="prod.nombre"/></a></td>
