<%-- 
    Document   : registro
    Created on : 02-jun-2013, 19:25:59
    Author     : Jorge
--%>
...
<html lang="es">
       ...
       <div class="container">
            ...
            <!-- Formulario inscripción -->
                        <div class="span9">
                            ...
                            <s:form action="Registrarse" class="form-horizontal">
                                 <div class =" span4">
                                <dt>
                                <br>
                                Registro
                                ...
                                <div class="control-group">
                                    <label for="nombreusu" class="control-label">Nombre Usuario</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="password" type="password"  name="password" class="input-xlarge" required oninput="check2(this)">

                                      
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="repcontraseña" class="control-label">Repetir Contraseña</label>
                                    <div class="controls">
                                        <input id="password2" type="password"  name="password2" class="input-xlarge" required oninput="check(this)">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="apellidos" class="input-xlarge" required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <input type="text" name="telefono" class="input-xlarge" required pattern="[0-9]{9}" title="Escriba su teléfono (9 dígitos)">
    ...
    <dt>
                                <div class="control-group">
                                    <label for="cuenta" class="control-label">Tarjeta de crédito</label>
                                    <div class="controls">
                    ...
                    <div class =" span2">
                                ...
                                <div class="control-group">
                                    <label for="tipo" class="control-label">Tipo de vía</label>
                                    <div class="controls">
                                        <input type="text" name="tipo" class="input-xlarge" style="width: 230px" required>

                                       
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="nombre_dir" class="control-label">Nombre</label>
                                    <div class="controls">
                                        <input type="text" name="nombrecalle" class="input-xlarge" style="width: 230px" required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" name="numero"  class="input-small" style="width: 35px" required min="1" title="Tiene que ser un número">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" name="piso"  class="input-small" style="width: 35px" required min="1" title="Tiene que ser un número">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="letra"  class="input-small" style="width: 18px" required min="1" >
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="localidad" class="input-medium" style="width: 90px">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="provincia" class="input-medium" style="width: 90px">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="pais" class="input-medium" style="width: 90px" required>
                                    </div>
                                </div>
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="cp" class="input-medium" style="width: 90px" required pattern="[0-9]{5}" title="Escriba su C.P (5 dígitos)">
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="btn btn-inverse btn-large pull-left" >Registrar</button>
                            </s:form>
                        </div>
                    </div>
                </div>
