<%-- 
    Document   : ofertas
    Created on : 02-jun-2013, 19:21:44
    Author     : Jorge
--%>
                ...
                <div class="span9">
                    ...
                    <div class="span9" >
                        <div class="row">
                            ...
                            <!-- producto --> 
                          <s:if test="#request.listaDestacados.size()>0">
                            <ul class="thumbnails">
                                <s:iterator value="#request.listaDestacados" var="producto">
                                    <li class="span3">
                                        <div class="thumbnail">
                                             <s:if test="imagen ">
                                                <img src="img/uploads/<s:property value="id"/>.jpg" style="width: 100%;height: 130px" alt="ALT NAME">
                                             </s:if>
                                             <s:else>
                                                <img src="img/null.jpg" style="width: 100%;height: 130px" alt="ALT NAME">
                                             </s:else>
                                            <div class="caption">

                                                <h3><a href="<s:url action="VerProducto"><s:param name="id" value="%{id}" /> </s:url>" ><s:property value="nombre"/></a></h3>
                                                <div>
                                                    <h2 ><s:property value="precio"/>€</h2>
                                                </div>
                          ...
                          <s:else>
                               <h4>No hay productos destacados en este instante.</h4>
                          </s:else>
                        </div>
                    </div>
                    ...
                    <!-- producto--> 
                     <s:if test="#request.listaOfertas.size()>0">
                    <ul class="thumbnails">
                        <s:iterator value="#request.listaOfertas" var="producto1">
                            <li class="span3">
                                <div class="thumbnail">
                                     <s:if test="imagen ">
                                                <img src="img/uploads/<s:property value="id"/>.jpg" style="width: 100%;height: 130px" alt="ALT NAME">
                                    ...
                                    <div class="caption">
                                        ...
                                        <s:form action="AnadirProductoCesta" method="post">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-primary pull-right"><i class="icon-shopping-cart icon-white"></i> Añadir</button>
                                            </div>
                                        </s:form>
                                    </div>
                                </div>
                     ...
                     <s:else>
                          <h4>No hay ofertas disponibles, espere a nuestras nuevas promociones.</h4>
                     </s:else>
                </div>
                <br>
                <div class="container">
